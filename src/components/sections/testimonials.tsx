    ...
    <section className="py-16 md:py-24 bg-[#f4f6f8] relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-4xl mx-auto flex flex-col items-center">
          <h2 className="text-[28px] md:text-5xl font-bold text-[#111827] tracking-tight mb-8 md:mb-12 leading-tight md:leading-[1.1] text-center text-balance max-w-4xl mx-auto">

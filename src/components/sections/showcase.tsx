...
export function ShowcaseSection() {
  ...
  return (
    <section className="pt-8 md:pt-12 pb-12 bg-[#f9f8f6] overflow-hidden">
      <div className="container mx-auto px-5 md:px-6 text-center flex flex-col items-center">
        ...
        >
          <h3 className="text-[#8c8273] font-bold tracking-widest uppercase text-[10px] md:text-xs mb-3 md:mb-4">SEAMLESS ACROSS DEVICES</h3>
          <h2 className="text-3xl md:text-5xl font-bold text-[#111827] tracking-tight text-balance">
        ...
        <motion.div 
          ...
          className="relative w-full lg:max-w-4xl xl:max-w-5xl h-[400px] sm:h-[500px] md:h-[700px] rounded-[2rem] md:rounded-[2rem] overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] bg-[#f9f8f6] border border-black/5"
        >

    ...
    <div className="bg-[#f9f8f6] dark:bg-[#0a0a0a] min-h-screen flex flex-col transition-colors duration-300">
      <main className="flex-1 pt-24 md:pt-32 pb-16 md:pb-24">
        ...
        <div className="px-5 md:px-12 max-w-7xl mx-auto">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-tr from-[#d4c5b5] to-[#a38b73] overflow-hidden flex items-center justify-center text-white font-bold text-sm md:text-base border-2 border-white dark:border-[#141414] shadow-sm transition-colors duration-300">
                        <Image src="/logo-final-nobg.png" alt="Author" width={32} height={32} className="opacity-80 block dark:hidden" />
                        <Image src="/logos/invert-logo.png" alt="Author" width={32} height={32} className="opacity-80 hidden dark:block" />
                      </div>
                      <div>
                        <p className="text-xs md:text-sm font-bold text-[#111827] dark:text-[#fafafa] transition-colors duration-300">LegalRobe Editorial</p>
                        <p className="text-[10px] md:text-xs text-[#6b7280] dark:text-[#737373] transition-colors duration-300">Legal Tech Insights</p>
                      </div>
                    </div>
          ...
          {/* Regular Posts Grid */}
          <section>
            <h3 className="text-xl md:text-2xl font-bold text-[#111827] dark:text-[#fafafa] mb-6 md:mb-8 transition-colors duration-300">Latest Articles</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {gridPosts.map((post) => (
                <Link href={`/blog/${post.slug}`} key={post.slug} className="group flex flex-col active:scale-[0.98] transition-transform duration-300">
                  <div className="bg-white dark:bg-[#141414] rounded-3xl border border-[#e5e0d8] dark:border-[#262626] shadow-sm flex-1 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div className="p-3">
                    ...
                    <div className="px-5 pb-6 pt-2 flex flex-col h-[calc(100%-14rem)] md:h-[calc(100%-16rem)]">
                      <div className="flex flex-wrap items-center gap-2 md:gap-3 mb-3 md:mb-4 text-[11px] md:text-xs">
                        ...
                        <span className="text-[#6b7280] dark:text-[#737373] transition-colors duration-300">{post.readTime}</span>
                      </div>
